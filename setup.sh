...
install_dependencies() {
	# System dependencies
	sudo pacman -Sy --noconfirm yay base-devel gcc vlc telegram-desktop git-delta neovim fzf ripgrep fd bat kubectl curlie exa zoxide ranger wezterm rofi git-filter-repo btop ttf-iosevkaterm-nerd ttf-jetbrains-mono ttf-victor-mono-nerd ttf-dejavu-nerd ttf-cascadia-mono-nerd awesome
