...
run_elevated_powershell_script() {
  ...
  powershell_command="\$process = Start-Process PowerShell -ArgumentList '-NoProfile -ExecutionPolicy Bypass -File \"${win_tmp_script}\"' -Verb RunAs -Wait -PassThru -WindowStyle Hidden; exit \$process.ExitCode"
