...
1. Inspect the current file, callers, tests, and local folder conventions before moving code.
...
7. Re-read the main call flow and confirm it is clearer than before.
...
- Summarize the design decisions: what moved, why that boundary fits, and how behavior was preserved.
