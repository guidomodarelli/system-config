---
name: refactor-ssr-data-fetching
...
Si datos SSR hidratan React, aplicar `prevent-ssr-hydration-mismatches`. En Nordic, usar `nordic-dev-verify` para evidencia runtime cuando esté disponible.
