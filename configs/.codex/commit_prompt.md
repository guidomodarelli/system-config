...
- Validation: run available lint and unit tests for the selected scope, report results, and explicitly report any missing validation commands with the reason.
...
- Run `git commit` using `final_commit_message` without asking for confirmation.
